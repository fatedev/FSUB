...
;		吉里吉里初期化
;------------------------------------------------------------------------------
@eval exp="var FateVersion='1.3.3 UBW'"
@eval exp="sf.route='UBW'"
;初期表示レイヤーの設定
...
@eval exp="property isCleared{getter{return sf.g凛トゥルー&sf.g凛グッド;}}"
@call storage=マクロ.ks
...
;再生テストへ
;@jump storage=playsaber.ks cond=System.getKeyState(VK_T)
