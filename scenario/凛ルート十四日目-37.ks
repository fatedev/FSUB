...
　みんな、凛ルートのグッドエンドの行き方、すっごく判り辛くて困ってるよね？[lr]
...
　そういう事らしいんで、余裕があったら三日目からやり直してみてねー！
@pgtg
@textoff
